...
async def get_vacancy(
    _id: str, vacancy_service: VacancyService = Depends()
) -> VacancyModel:
...
async def get_vacancys(
    search_request: SearchRequest, vacancy_service: VacancyService = Depends()
):
...
async def upload_vacancy(
    vacancy: VacancyModel, vacancy_service: VacancyService = Depends()
):
...
async def close_vacancy(
    vacancy_id: str, vacancy_service: VacancyService = Depends()
) -> VacancyModel:
